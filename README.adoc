...
. Create a git repo from this template (suggested naming: `<lab-name>-showroom`)
...
See the https://rhpds.github.io/showroom_template_nookbag/[Content Repository docs] for directory layout, Podman Compose with live reload, dev mode, and more.
