...
// Usage: include::common/solve-button.adoc[module-name]
// Where module-name is the data-module attribute (e.g., module-01, module-02, etc.)
...
<div class="solve-button-placeholder" data-module="{0}"></div>
