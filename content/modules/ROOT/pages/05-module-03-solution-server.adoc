...
+
image::module-03/Analysis-Config2.png[Analysis Configuration,link=self,window=blank,title="Analysis Configuration"]
+
* Notice __Hub Configuration__ is not yet configured
...
. Return focus to **MTA Analysis View**
+
* Ensure the **Get Ready to Analyze** panel is closed
* Ensure the **MTA Hub Configuration Tab/Pane** is closed
