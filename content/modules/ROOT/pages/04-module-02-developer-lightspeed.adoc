...
* Source Technologies:
* Click dropdown arrow and type or scroll to **java-ee** and **openjdk8**
...
* Note how LLM via the **mta-vscode-extension AI** respondant provides reasoning, change suggestions, and a fully converted Quarkus code approach to replace the existing approach.
...
+
* At the top of the file is a prompt/link to **Accept All Changes or Reject All Changes**
