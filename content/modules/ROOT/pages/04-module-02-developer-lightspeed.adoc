...
TIP:  If you ever accidently close the MTA Analysis View panel, just click on the MTA Extension icon and click on the book icon in the pane just to the right, at the top. image:module-02/Open-open-analysis-view.png[Open Analysis Pane Icon,link=self,window=blank,title="Open Analysis Pane Icon",250,250]
+
...
Want to verify you completed the exercises correctly? Click the button below to validate your work:
