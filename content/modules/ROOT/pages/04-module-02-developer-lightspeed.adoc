...
+
TIP:  If you ever accidently close the MTA Analysis View panel, just click on the MTA Extension icon and click on the reading pages icon in the pane just to the right, at the top.
+
