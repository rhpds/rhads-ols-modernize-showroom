...
+
image::module-02/login-devspaces.png[]
+
...
+
image::module-02/workspace-listing.png[]
...
+
image::module-02/vscode-getstarted.png[]
...
+
image::module-02/MTA-extension.png[]
TIP:  If you ever accidently close the MTA Analysis View panel, just click on the MTA Extension icon and click on the reading pages icon in the pane just to the right, at the top. image:module-02/Open-open-analysis-view.png[250,250]
+
* Click **Manage Profiles** on the screen
+
image::module-02/MTA-analysis-view.png[]
+
* This will open the MTA Manage Profiles panel
* Click **New Profile**
+
image::module-02/MTA-profile-filling.png[]
+
...
+
image::module-02/MTA-Profile-settings.png[]
+
...
+
image::module-02/Analysis-hub.png[]
+
* The **provider-settings.yaml** file will open on a separate pane
+
image::module-02/provider-settings.png[]
+
...
+
TIP:  If you ever accidently close the MTA Analysis View panel, just click on the MTA Extension icon and click on the reading pages icon in the pane just to the right, at the top. image:module-02/reopen-analysis-pane.png[250,250]
+
...
====
+
image::module-02/Initial-analysis.png[]
+
...
+
image::module-02/EJB-get-solution.png[]
+
...
+
image::module-02/EJB-GenAI-results.png[]
...
+
image::module-02/EJB-review-accept-changes.png[]
+
