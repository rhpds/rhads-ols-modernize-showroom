...
* [cite_start]**Enable Insecure Repositories:** In the *Administration* perspective, go to *Repositories > Git* and toggle *Consume insecure Git repositories* to the right.
...
* **Retake & Navigate:** Click *Retake* [cite: 68], then click *Next* through the Stakeholders and initial sections (Details, Dependencies, Observability).
