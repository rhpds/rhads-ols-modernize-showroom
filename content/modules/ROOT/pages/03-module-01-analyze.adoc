= Module 1: Assessment and analysis
...
* Navigate the MTA application inventory and application profiles
* Understand tags, archetypes, and business services
* Complete an assessment questionnaire for an archetype
* Configure and run source code analysis
* Review analysis reports and identify migration issues
...
image::mta-analyze/mta-application-inventory.png[application inventory,link=self,window=_blank]
...
image::mta-analyze/mta-inventory-profile.png[inventory,link=self,window=_blank]
...
image::mta-analyze/mta-inventory-profile-tags.png[inventory,link=self,window=_blank]
...
image::mta-analyze/mta-archetypes.png[archetypes,link=self,window=_blank]
...
image::mta-analyze/mta-archetypes-summer.png[archetypes,link=self,window=_blank]
...
image::mta-analyze/mta-archetypes-inventory-customers.png[inventory,link=self,window=_blank]
...
image::mta-analyze/mta-archetypes-inventory-customers-tags.png[inventory,link=self,window=_blank]
...
image::mta-analyze/mta-control-stakeholder.png[stakeholders,link=self,window=_blank]
...
image::mta-analyze/mta-stakeholder-groups.png[stakeholder-groups,link=self,window=_blank]
...
image::mta-analyze/mta-control-business-service.png[business service,link=self,window=_blank]

=== Verify

You have now explored the MTA inventory, application profiles, and controls.

Expected state:

✓ MTA console is accessible
✓ Application inventory shows multiple applications
✓ Customers application profile is visible
✓ Tags and archetypes are associated with applications
...
image::mta-analyze/mta-questionnaires.png[questionnaires,link=self,window=_blank]
...
image::mta-analyze/mta-questionnaires-enabled.png[questionnaires,link=self,window=_blank]
...
image::mta-analyze/mta-intentory-assessed.png[questionnaires,link=self,window=_blank]
...
image::mta-analyze/mta-assessment-summer.png[archetypes,link=self,window=_blank]
...
image::mta-analyze/mta-assessment-summer-options.png[assessment,link=self,window=_blank]
...
image::mta-analyze/mta-assessment-stakeholders.png[assessment,link=self,window=_blank]
...
image::mta-analyze/mta-assessment-app-details.png[app-details,link=self,window=_blank]
...
image::mta-analyze/mta-assessment-app-cross-cutting-concerns.png[app-cross-cutting-concerns,link=self,window=_blank]
...
image::mta-analyze/mta-review.png[review,link=self,window=_blank]
...
image::mta-analyze/mta-review-risks.png[review-risks,link=self,window=_blank]
...
image::mta-analyze/mta-submit-review.png[submit-review,link=self,window=_blank]
...
image::mta-analyze/mta-complete-review.png[complete-review,link=self,window=_blank]
...
image::mta-analyze/mta-complete-review-values.png[complete-review,link=self,window=_blank]

To see an aggregated view of assessment data across the entire portfolio, go to the `Report` option on the left menu.

image::mta-analyze/mta-report-review.png[report-review,link=self,window=_blank]

=== Verify

You have completed the assessment for the Summer Framework archetype.

Expected results:

✓ Legacy Pathfinder questionnaire is enabled
✓ Assessment completed with configuration answer selected
✓ Review submitted with Refactor strategy and Small effort
✓ Customers application inherited assessment from archetype
...
image::mta-analyze/mta-admin-git.png[admin git,link=self,window=_blank]
...
image::mta-analyze/mta-application-update-git.png[application-update-git,link=self,window=_blank]
...
image::mta-analyze/mta-application-discovery.png[application-discovery,link=self,window=_blank]
...
image::mta-analyze/mta-application-discovery-tags.png[application-discovery,link=self,window=_blank]
...
image::mta-analyze/mta-application-analysis.png[application-analysis,link=self,window=_blank]
...
image::mta-analyze/mta-application-analysis-mode.png[Analysis mode,link=self,window=_blank]
...
image::mta-analyze/mta-application-analysis-targets.png[Analysis targets,link=self,window=_blank]
...
image::mta-analyze/mta-application-analysis-scope.png[Analysis scope,link=self,window=_blank]
...
image::mta-analyze/mta-application-analysis-custom-rules.png[Custom rules,link=self,window=_blank]
...
image::mta-analyze/mta-application-analysis-custom-rules-add-repo.png[add-repository-customrules,link=self,window=_blank]
...
image::mta-analyze/mta-application-analysis-advanced.png[Advanced,link=self,window=_blank]

Click on `Next`.

Lastly, we are presented with a summary of the configuration for our analysis.

image::mta-analyze/mta-application-analysis-review.png[Review,link=self,window=_blank]
...
image::mta-analyze/mta-application-analysis-scheduled.png[Analysis scheduled,link=self,window=_blank]
...
✓ Analysis status changes from Scheduled → In Progress → Completed
✓ No errors in the analysis execution
...
image::mta-analyze/mta-application-analysis-effort.png[Effort,link=self,window=_blank]
...
image::mta-analyze/mta-application-analysis-tags.png[Analysis tags,link=self,window=_blank]
...
image::mta-analyze/mta-application-analysis-issues.png[Issues,link=self,window=_blank]
...
image::mta-analyze/mta-application-analysis-issues-ip-files.png[Issues,link=self,window=_blank]
...
image::mta-analyze/mta-application-analysis-issues-ip-snippet.png[Issues,link=self,window=_blank]
...
image::mta-analyze/mta-application-analysis-issues-config-files.png[Issues,link=self,window=_blank]

Only the `PersistenceConfig` class seems to be affected by the issue. Click on it to know more:

image::mta-analyze/mta-application-analysis-issues-config-snippet1.png[Issues,link=self,window=_blank]
...
image::mta-analyze/mta-application-analysis-issues-config-snippet2.png[Issues,link=self,window=_blank]
...
image::mta-analyze/mta-application-analysis-dependencies.png[Dependencies,link=self,window=_blank]
...
You have completed the analysis review.

Expected results:

✓ Story points calculated for migration effort
✓ Technology stack tags automatically added
✓ Issues identified including hardcoded IP and legacy configuration
✓ Dependencies catalogued and categorized
...
* Use tags and archetypes to classify applications at scale
* Complete assessment questionnaires to identify migration risks
* Configure and execute source code analysis
* Review analysis reports including effort, issues, and dependencies
* Identify specific code locations that need remediation

You can now proceed to the next module where you will fix the identified issues and deploy the modernized application.
